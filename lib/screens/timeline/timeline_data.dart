...
final timelineData = {
  0: [ // Day 1
    ...
    TimelineEvent(time: "All Day", title: "SpeedCubing", venue: "Lords"),
    ...
    TimelineEvent(time: "6:00 PM onwards", title: "Robo Rumble", venue: "Lords"),
  ...
  1: [ // Day 2
    ...
    TimelineEvent(time: "10:00 AM - 5:00 PM", title: "Death Race", venue: "Lords"),
    TimelineEvent(time: "10:00 AM - 5:00 PM", title: "Robo Rumble", venue: "Lords"),
    ...
    TimelineEvent(time: "6:00 PM onwards", title: "Robowar", venue: "Lords"),
    TimelineEvent(time: "6:00 PM onwards", title: "Aerocraft & Robosoccer", venue: "NB"),
  ],
  2: [ // Day 3
    TimelineEvent(time: "9:00 AM - 6:00 PM", title: "Hackathon", venue: "Various Locations"),
    TimelineEvent(time: "Online Event", title: "Chitrakatha", venue: "Online"),
    TimelineEvent(time: "Before 12:00 PM", title: "Photowalk", venue: ""),
    TimelineEvent(time: "All Day", title: "Real Cricket", venue: "Lords"),
    TimelineEvent(time: "All Day", title: "SpeedCubing", venue: "Lords"),
