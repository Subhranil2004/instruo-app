...
final List<Event> events = [
  ...
  Event(
    ...
    maxTeamSize: 2,
    fee: 100,
    coordinator: "Divyanand Tripathi",
    phone: "8305274961",
  ),
  Event(
    id: "tech5",
  ...
  Event(
    ...
    maxTeamSize: 1,
    fee: 100,
    coordinator: "Anurag Singh",
    phone: "8169687574",
  ),
  Event(
    id: "gen5",
    category: "general",
    name: "Founder's Goal", ///////////////////////////needs correction
    image: "assets/fest.png",
    description: "",
    rules: "",
    minTeamSize: 1,
  ...
  Event(
    ...
    rules: "https://docs.google.com/document/d/1l5BknJnwCEIiQ2RCc8vRBmaa-Gcw1TD_/edit?usp=sharing&ouid=116690350005654047734&rtpof=true&sd=true",
    minTeamSize: 4,
    maxTeamSize: 4,
    fee: 100,
    coordinator: "Bikarm Kumar",
    phone: "6203294110",
  ),
  Event(
    id: "game3",
